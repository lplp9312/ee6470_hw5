...
void GauFilter_wrapper::InitInstances(  )
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    GauFilter_cosim0->i_rgb_busy(i_rgb.busy);
		    GauFilter_cosim0->i_rgb_vld(i_rgb.vld);
		    GauFilter_cosim0->i_rgb_data(i_rgb.data);
        ...
        case BDWRep_CYC_HDL:
		    ...
		    GauFilter_cycsim0->i_rgb_busy(i_rgb.busy);
		    GauFilter_cycsim0->i_rgb_vld(i_rgb.vld);
		    GauFilter_cycsim0->i_rgb_data(i_rgb.data);
		...
		case BDWRep_RTL_C:
		    ...
		    GauFilter_rtl0->i_rgb_busy(i_rgb.busy);
		    GauFilter_rtl0->i_rgb_vld(i_rgb.vld);
		    GauFilter_rtl0->i_rgb_data(i_rgb.data);
		...
		case BDWRep_Behavioral:
		    ...
		    GauFilter0->i_rgb.busy(i_rgb.busy);
		    GauFilter0->i_rgb.vld(i_rgb.vld);
		    GauFilter0->i_rgb.data(i_rgb.data);
...
void GauFilter_wrapper_r::InitInstances()
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    GauFilter_cosim0->i_clk(i_clk);
		    GauFilter_cosim0->i_rst(i_rst);
		    GauFilter_cosim0->i_rgb_busy(i_rgb_busy);
		    GauFilter_cosim0->i_rgb_vld(i_rgb_vld);
		    GauFilter_cosim0->i_rgb_data(i_rgb_data);
        ...
        case BDWRep_CYC_HDL:
		    ...
		    GauFilter_cycsim0->i_clk(i_clk);
		    GauFilter_cycsim0->i_rst(i_rst);
		    GauFilter_cycsim0->i_rgb_busy(i_rgb_busy);
		    GauFilter_cycsim0->i_rgb_vld(i_rgb_vld);
		    GauFilter_cycsim0->i_rgb_data(i_rgb_data);
		...
		case BDWRep_RTL_C:
		    ...
		    GauFilter_rtl0->i_clk(i_clk);
		    GauFilter_rtl0->i_rst(i_rst);
		    GauFilter_rtl0->i_rgb_busy(i_rgb_busy);
		    GauFilter_rtl0->i_rgb_vld(i_rgb_vld);
		    GauFilter_rtl0->i_rgb_data(i_rgb_data);
